...
public class AndroidVideoCaptureExample extends Activity {
	...
	private Button button, btnRecordVideo;
   ...
   /*private void captureImage() {
	...
	private void previewVideo() {
		try {
			...
			videoPreview.setVideoPath(String.valueOf(fileUri));
			// start playing
			videoPreview.start();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public Uri getOutputMediaFileUri(int type) {
		return FileProvider.getUriForFile(AndroidVideoCaptureExample.this, BuildConfig.APPLICATION_ID+".provider",getOutputMediaFile(type));
